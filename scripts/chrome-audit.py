...
SCENARIOS=[
  ...
  {"name":"phone-360-dark-standard-koah","width":360,"height":800,"theme":"dark","mode":"standard","case":"koah"},
  {"name":"phone-390-light-field-hypovolemic","width":390,"height":844,"theme":"light","mode":"field","case":"hypovolemic-shock"},
  {"name":"phone-430-dark-standard-heartfailure","width":430,"height":932,"theme":"dark","mode":"standard","case":"acute-heart-failure-cardiogenic-shock"},
  {"name":"tablet-768-light-standard-consciousness","width":768,"height":1024,"theme":"light","mode":"standard","case":"altered-consciousness"},
  {"name":"phone-390-light-standard-asthma","width":390,"height":844,"theme":"light","mode":"standard","case":"asthma"},
]
...
(async()=>{
  ...
  const result={
    ...
    severityTabs:[...document.querySelectorAll('#severity .severity-tab')].filter(visible).map(e=>text(e)),
    categoryFilters:[...document.querySelectorAll('#filterRow .filter-chip')].filter(visible).map(e=>text(e)),
