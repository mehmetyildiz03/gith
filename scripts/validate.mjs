...
if(APP_META?.contentVersion!=='EK2-2026.08.25-source-fidelity-recheck-2-2026.09.24')err('contentVersion V0.44 sıkı kaynak sadakati yeniden kontrol sürümüyle eşleşmiyor');
if(APP_META?.productVersion!=='0.44')err('productVersion V0.44 olmalı');
