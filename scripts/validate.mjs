...
if(APP_META?.contentVersion!=='EK2-2026.08.25-full-audit-1-2026.09.23')err('contentVersion tam kapsam audit sürümüyle eşleşmiyor');
if(APP_META?.productVersion!=='0.25')err('productVersion V0.25 olmalı');
