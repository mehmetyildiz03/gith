...
assert(html.includes('styles.css?v=0.21')&&html.includes('app-core.js?v=0.21')&&html.includes('cases-data.js?v=0.21'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v021")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
...
assert(data.includes('"contentVersion": "EK2-2026.08.25-action-authority-3-2026.09.23"'),'V0.21 dallı eylem yetki sürümü eksik');
