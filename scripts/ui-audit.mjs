...
assert(html.includes('styles.css?v=0.16')&&html.includes('app-core.js?v=0.16')&&html.includes('cases-data.js?v=0.16'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v016")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
...
assert(data.includes('"contentVersion": "EK2-2026.08.25-practitioner-authority-2-2026.09.22"'),'V0.16 ikinci uygulayıcı yetki audit paketi eksik');
