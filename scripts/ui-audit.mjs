...
assert(css.includes('-webkit-line-clamp:2')&&css.includes('.priority-badge{flex:0 0 auto;margin-top:1px}'),'Mobil vaka listesinde uzun başlıklar iki satıra kadar görünür değil');
