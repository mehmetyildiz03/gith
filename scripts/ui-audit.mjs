...
assert(html.includes('styles.css?v=0.11')&&html.includes('app-core.js?v=0.11')&&html.includes('cases-data.js?v=0.11'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v011")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
...
assert(data.includes('"contentVersion": "EK2-2026.08.25-adult-expansion-2-2026.09.22"'),'V0.11 ikinci yetişkin genişleme içerik sürümü eksik');
