...
assert(html.includes('styles.css?v=0.8.2')&&html.includes('app-core.js?v=0.8.2')&&html.includes('cases-data.js?v=0.8.2'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v082")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
