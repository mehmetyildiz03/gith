...
assert(html.includes('styles.css?v=0.18')&&html.includes('app-core.js?v=0.18')&&html.includes('cases-data.js?v=0.18'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v018")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
...
assert(data.includes('"contentVersion": "EK2-2026.08.25-practitioner-authority-4-2026.09.22"'),'V0.18 yetişkin ilaç uygulayıcı auditi tamamlama sürümü eksik');
