...
assert(html.includes('styles.css?v=0.17')&&html.includes('app-core.js?v=0.17')&&html.includes('cases-data.js?v=0.17'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v017")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
...
assert(data.includes('"contentVersion": "EK2-2026.08.25-practitioner-authority-3-2026.09.22"'),'V0.17 üçüncü uygulayıcı yetki audit paketi eksik');
