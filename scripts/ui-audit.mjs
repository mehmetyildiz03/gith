...
assert(html.includes('styles.css?v=0.12')&&html.includes('app-core.js?v=0.12')&&html.includes('cases-data.js?v=0.12'),'Kritik asset cache-bust sürümü eksik');
assert(sw.includes("saha112-v012")&&sw.includes('NETWORK_FIRST_DESTINATIONS'),'Service worker kritik asset güncelleme stratejisi eksik');
...
assert(data.includes('"contentVersion": "EK2-2026.08.25-adult-expansion-3-2026.09.22"'),'V0.12 üçüncü yetişkin genişleme içerik sürümü eksik');
