...
function openCase(id){
  ...
  const jumps=[['critical-actions','İlk adımlar','critical'],['algorithm','Algoritma',''],...(c.severity?[['severity','Klinik ayrım','']]:[]),['red-flags','Acil uyarılar','critical'],...(c.meds?.length?[['medications','İlaçlar','']]:[]),...(!c.decisionIntegrated?[['decision','Karar','']]:[]),['source','Kaynak','']];
